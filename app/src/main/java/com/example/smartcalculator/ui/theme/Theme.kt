...
private val DarkColors = darkColorScheme(
    ...
    secondaryContainer = PanelAppleDark,   // #38414D — 苹果风格面板色
    onSecondaryContainer = Text50,
    tertiary = Chart5,
    onTertiary = Color.Black,
    tertiaryContainer = Color(0xFF4A1B6E),
    onTertiaryContainer = Color(0xFFEEDCFF),
    background = BackgroundAppleDark,        // #303842 — 苹果风格深背景
    onBackground = ForegroundDark,
    surface = PanelAppleDark,               // #38414D — 面板色
    onSurface = CardForegroundDark,
    surfaceVariant = Color(0xFF444E59),     // 略浅于面板的次级色
    ...
    outline = BorderDark,
    outlineVariant = Color(0xFF4A545F),
    scrim = Color.Black,
)
